...
class HttpServer(metaclass=ABCMeta):
    ...
    主要接口是 update 和 request_analysis
    """
    session = None
    __myheaders = None
    __myproxy = None
    ...
    def __randomAgent(self):
        '''随机生成一个User-Agent'''
        return random.choice(['Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.75 Safari/537.36',
